...
const (
	...
	// AnnotationShootWireguardTunnel is the key for an annotation of a Shoot cluster who is using the wireguard tunnel.
	AnnotationShootWireguardTunnel = "alpha.featuregates.shoot.gardener.cloud/wireguard-tunnel"
